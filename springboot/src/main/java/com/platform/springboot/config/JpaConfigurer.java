...
import com.platform.springboot.support.jpa.CustomJpaRepositoryImpl;
...
import com.platform.springboot.support.jpa.CustomRepositoryFactoryBean;
import com.platform.springboot.support.jpa.SpringSecurityAuditorAware;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.platform.springboot.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
/*@EnableJpaRepositories(basePackages =
 "com.platform.springboot.web.repository",
